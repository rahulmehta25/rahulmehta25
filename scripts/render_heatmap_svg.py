...
rounded colored boxes in a 53-week x 7-day calendar, revealed once with a
diagonal slide-down, plus Less->More legend and a stats footer.
"""
import datetime
import json
import os
...
""".strip()
    ...
    parts.append(
        ...
        f'text-anchor="middle">{HOST}: ~/contributions --graph</text>'
    )
